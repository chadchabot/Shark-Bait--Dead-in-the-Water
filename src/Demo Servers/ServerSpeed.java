...
public class ServerSpeed
{
	public static void main(String[] args)
	{
		try
		{
            ...
            client_out.writeBytes("shipState:1:400:450:5:45:3.0;\n");
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			client_out.writeBytes("shipState:1:400:450:15:45:3.0;\n");
            try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			client_out.writeBytes("shipState:1:400:450:30:45:3.0;\n");
            try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			client_out.writeBytes("shipState:1:400:450:60:45:3.0;\n");
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
