...
public class ServerDir
{
	public static void main(String[] args)
	{
		try
		{
			...
			client_out.writeBytes("shipState:1:400:450:0:45:3.0;\n");
            try {
				Thread.sleep(1000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			client_out.writeBytes("shipState:1:400:450:0:90:3.0;\n");
            try {
				Thread.sleep(1000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			client_out.writeBytes("shipState:1:400:450:0:135:3.0;\n");
			try {
				Thread.sleep(1000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
            ...
            client_out.writeBytes("shipState:1:400:450:0:180:3.0;\n");
			try {
				Thread.sleep(1000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
